    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_id', models.IntegerField(unique=True, validators=[django.core.validators.MaxValueValidator(99999999)])),
                ...
                ('student_level', models.IntegerField(validators=[django.core.validators.MaxValueValidator(4)])),
                ('student_gpa', models.DecimalField(decimal_places=2, max_digits=3)),
                ('student_dep', models.CharField(choices=[('General', 'general'), ('Computer science', 'computer Science'), ('Information system', 'information System'), ('Internet technology', 'internet Technology'), ('Artificial Intelligence', 'artificial intelligence'), ('Decision Support', 'decision support')], max_length=50)),
                ...
                ('student_landline', models.CharField(blank=True, max_length=10, null=True)),
